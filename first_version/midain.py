...
def best_balance_parameter(data,number_of_points = 50):
    ...
    f = open("./figure/best_balance_parameter_median/best_balance_median.txt","w")
    f.write("best balance parameter(median function) ="+str(c_array[0][index_min]))
    f.close()
...
# data = np.random.normal(mean, standard_deviation, number_of_number)
# print np.sort(data)
# print "median data(even):",np.median(data)
# data = np.random.normal(mean, standard_deviation, number_of_number+1)
# print np.sort(data)
# print "median data(odd):",np.median(data)
...
path = "./figure/best_balance_parameter_median/"
epsilon_array = np.loadtxt(path  + "real_median_epsilon.txt")
c_array = np.loadtxt(path  + "real_median_array.txt")
error = np.loadtxt(path +   "real_median_error.txt")



# privacy_array = np.linspace(0.01,0.5,20)
privacy_array=epsilon_array = np.linspace(0.1, 0.5, 10)
...
plt.plot(privacy_array, result_laplace+0.1, 'g-', linewidth=2, label='laplace')
plt.legend(loc='upper right',fontsize=font_size)
# plt.title('comparison of error for medain function')
