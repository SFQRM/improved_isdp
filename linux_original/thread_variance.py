...
def best_balance_parameter(data,number_of_points = 50,name=""):
    ...
    epsilon_array = np.linspace(0.05, 1, 10)
    ...
    # f.close()
    print "constant:",c_array[0][index_min]
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    plt.savefig('../figure/thread_standard_deviation.png',dpi=600, bbox_extra_artists=(),bbox_inches='tight')
    plt.show()
