...
def one_data_set(epsilon, mean, standard_deviation, number_of_number, repeate, number_of_thread):
    ...
    return [result_sample_aggreation, result_personlized_sample, result_laplace]
...
if __name__ == '__main__':
    ...
    fig = plt.figure()
    plt.plot(privacy_array, result_sample_aggreation, 'r-', linewidth=2, label='sample and aggregate')
    plt.plot(privacy_array, result_personlized_sample, 'b-', linewidth=2, label='individualized sample laplace')
